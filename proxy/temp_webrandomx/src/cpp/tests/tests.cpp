...
int main() {
	...
	runTest("Dataset initialization", stringsEqual(RANDOMX_ARGON_SALT, "RandomX\x03"), []() {
		initCache("test key 000");
	...
	runTest("Hash test 1a", stringsEqual(RANDOMX_ARGON_SALT, "RandomX\x03"), test_a);

	runTest("Hash test 1b", stringsEqual(RANDOMX_ARGON_SALT, "RandomX\x03"), test_b);

	runTest("Hash test 1c", stringsEqual(RANDOMX_ARGON_SALT, "RandomX\x03"), test_c);

	runTest("Hash test 1d", stringsEqual(RANDOMX_ARGON_SALT, "RandomX\x03"), test_d);

	runTest("Hash test 1e", stringsEqual(RANDOMX_ARGON_SALT, "RandomX\x03"), test_e);
